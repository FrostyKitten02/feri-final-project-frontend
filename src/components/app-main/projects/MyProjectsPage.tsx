...
export const MyProjectsPage = () => {
  ...
  const [selectedStatus, setSelectedStatus] = useState<SelectedItemProps>({
    value: "",
    text: "",
  });
      ...
      {isLoading ? (
        ...
        <>
          <div className="relative p-5">
            <div className="border-[1px] border-solid rounded-[20px] border-gray-200 flex flex-col flex-grow p-5">
              <ProjectFilter
          ...
          <>
            <div className="relative flex-grow p-5">
              ...
              {projects?.projects && projects.projects.length > 0 && (
                <div className="absolute rounded-[20px] text-center text-muted bg-white bottom-[4px] font-medium right-20 uppercase flex px-2">
                  <CustomPagination
