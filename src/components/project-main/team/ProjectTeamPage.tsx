        ...
        <div className="w-full h-full px-12 rounded-bl-[20px]">
          {loading ? (
            ...
            <div className="flex flex-col h-full">
              <div className="grid grid-cols-[80px_1fr_1fr_1fr_0.5fr_0.5fr] pt-8 pb-4 px-3">
                <div />
              ...
              <div className="flex-grow overflow-y-auto px-3">
                <div className="rounded-2xl border border-solid border-gray-200 bg-white divide-y divide-solid divide-gray-200">
                  {peopleOnProject?.map((person) => (
                    <div
                      className="grid grid-cols-[80px_1fr_1fr_1fr_0.5fr_0.5fr] py-6"
                      key={person.id}
                    >
                      ...
                      <div className="flex items-center px-4 justify-start text-sm font-semibold overflow-hidden">
